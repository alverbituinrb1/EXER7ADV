...
const Profile = () => {
    ...
    return (
        <div className="h-screen max:h-screen-auto flex justify-center items-center bg-background">
            <div className="w-1/2 rounded-md bg-box-color justify-between flex-col font-mono">
                ...
                <div className="flex items-start justify-evenly flex-col w-1/2 self-center ">
                    <div className="text-white font-sans text-lg">Email: {userInfo?.email}</div>
                    <div className="text-white font-sans text-lg">Name: {userInfo?.displayName}</div>
                </div>
